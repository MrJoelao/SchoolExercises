...
Resources: A number of resources are used, such as images for the slot machine icons and sound files for the game sounds. Assets: [Icons](https://www.flaticon.com/uicons), [Music](https://www.youtube.com/watch?v=8nz_BWvCF_4).
