 ...
 * @author joel
 */
// Slot machine graphical user interface class
public class SlotMachineGUI extends javax.swing.JFrame {
    // Slot machine instance
    SlotMachine slotMachine = new SlotMachine(5, 250, 10000);
    ...
    // This method plays a sound file located at the specified path
    // It can loop the sound if the 'loop' parameter is set to true
    // It uses the WAV format, and an external converter can be used to convert MP3 to WAV
    public static void play(String path, boolean loop){
        try {
            // Get the URL of the audio file
            URL url = SlotMachine.class.getResource("/Musica/" + path);
            if (url != null) {
    ...
    private void initComponents() {
        ...
        jackpot_asset = new javax.swing.JLabel();
        ...
        jackpot_asset.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jackpot_asset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Foto/jackpot.png"))); // NOI18N
        pannel.add(jackpot_asset);
        jackpot_asset.setBounds(610, 30, 150, 90);
    ...
    javax.swing.JLabel jackpot_asset;
